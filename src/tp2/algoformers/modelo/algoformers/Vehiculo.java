...
public abstract class Vehiculo implements Estado {
    ...
    public Estado transformarOptimus(Algoformer algoformer){
        ...
        algoformer.setDireccionDeImagen("file:src/tp2/algoformers/vista/imagenes/algoformers/optimusPrime.png");
    ...
    public Estado transformarBumblebee(Algoformer algoformer){
        ...
        algoformer.setVelocidadDeDesplazamiento(2);
        algoformer.setDireccionDeImagen("file:src/tp2/algoformers/vista/imagenes/algoformers/bumblebee.png");
        return new Humanoide();
    }
    ...
    public Estado transformarBonecrusher(Algoformer algoformer){
        ...
        algoformer.setDireccionDeImagen("file:src/tp2/algoformers/vista/imagenes/algoformers/bonecrusher.png");
        return new Humanoide();
    }
    ...
    public Estado transformarFrenzy(Algoformer algoformer){
       algoformer.setAtaque(10);
        ...
        algoformer.setVelocidadDeDesplazamiento(2);
        algoformer.setDireccionDeImagen("file:src/tp2/algoformers/vista/imagenes/algoformers/frenzy.png");
        return new Humanoide();
    }
    ...
    @Override
        ...
        algoformer.setDistanciaDeAtaque(3);
        algoformer.setVelocidadDeDesplazamiento(1);
        algoformer.setDireccionDeImagen("file:src/tp2/algoformers/vista/imagenes/algoformers/Megatron.png");
        return new Humanoide();
    }
    ...
    public Estado transformarRatchet(Ratchet algoformer){
        ...
        algoformer.setDistanciaDeAtaque(5);
        algoformer.setVelocidadDeDesplazamiento(1);
        algoformer.setDireccionDeImagen("file:src/tp2/algoformers/vista/imagenes/algoformers/ratchet.png");
        return new Humanoide();
    }
