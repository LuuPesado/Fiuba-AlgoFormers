...
import tp2.algoformers.NoPuedoAtacarUnCompañeroException;
...
public class PruebasAlgoformer {
    ...
    @Test(expected=NoPuedoAtacarUnCompañeroException.class)
    public void test05AlgoformersDeMismoBandoNoSePuedenAtacar(){
        ...
        tablero.ubicarAlgoformerEnUnaPosicion(13, 12, decepticon2);
