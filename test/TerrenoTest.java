...
public class TerrenoTest {
	...
	public void test01AtraviesanZonaRocosaSinProblemas(){
		...
		Assert.assertTrue(optimus.posicion().getFila() == 3);
        Assert.assertTrue(optimus.posicion().getColumna() == 3);
	}
	...
	public void test04PantanoNoAfectaAlgoformerEnModoAereo(){
		...
		Assert.assertTrue(megatron.posicion().getFila() == 21);
        Assert.assertTrue(megatron.posicion().getColumna() == 13);
	}
	...
	public void test07NubesNoAfectanAlgoformerEnModoAereo(){
		...
		Assert.assertTrue(megatron.posicion().getFila() == 58);
        Assert.assertTrue(megatron.posicion().getColumna() == 58);
	}
	
	@Test
	public void test08LaTormentaPsionicaBajaElAtaqueDeUnAlgoformer(){
		Algoformer megatron = new Megatron();
	...
	@Test
	public void test09LaTormentaPsionicaNoBajaElAtaqueAlPasarPorSegundaVez(){
		Algoformer megatron = new Megatron();
