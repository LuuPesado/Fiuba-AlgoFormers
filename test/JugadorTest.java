...
public class JugadorTest {
    ...
    public void test01CuandoUnJugadorJuegaUnoDeSusAlgoformersEnUnaPosicionVaciaElAlgoformerSeMueveAlli(){
        ...
        jugador1.jugar(decepticons.get(0), posicionDeDestino);
        Assert.assertTrue(jugador1.elegirAlgoformer(decepticons.get(0)).getPosicion().equals(posicionDeDestino));
    ...
    public void test02CuandoUnJugadorJuegaUnoDeSusAlgoformersASuPropiaPosicionSeTranforma(){
        ...
        jugador1.jugar(decepticons.get(0), posicionDeDestino);
        Assert.assertTrue(jugador1.elegirAlgoformer(decepticons.get(0)).getVelocidad()==8);//La velocidad que tiene cuando es vehiculo.
        Tablero.getTablero().reiniciarTablero();
    }
    ...
    public void test03CuandoUnJugadorMueveAUnoDeSusAlgoformersALaPosicionDeUnoDeSusRivalesLoAtaca(){
        ...
        jugador2.jugar(autobots.get(0), posicionDeDestino);
        Assert.assertEquals(jugador1.elegirAlgoformer(decepticons.get(0)).puntosDeVida(), 500);
        //Megatron arranca con 550 puntos de vita y si Optimus lo atacadoPor le quita 50.
        Tablero.getTablero().reiniciarTablero();
    }
    
    @Test (expected = EseAlgoformerPerteneceAlOtroJugadorException.class)
    public void test04cuandoUnJugadorEligeUnAlgoformerQueNoLeCorrespondeSeLanzaUnaExcepcion(){
    	Posicion unaPosicion = new Posicion(3,4);
    	jugador2.jugar(decepticons.get(1), unaPosicion);
    }
}
